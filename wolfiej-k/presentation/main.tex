...
\begin{frame}{Experimental Setup}
	\begin{itemize}
        ...
        \begin{itemize}
            ...
            YCSB.
        \end{itemize}
        \item Measurement: 5s warmup, 10s timed window, sampled per-op
...
\begin{frame}{Shared Memory Overhead}
    ...
    \begin{columns}[T, onlytextwidth]
        \column{0.46\textwidth}\centering
            ...
            {\scriptsize\itshape Throughput + L2 TLB misses vs. threads}
        \column{0.46\textwidth}\centering
            \includegraphics[width=\linewidth]{arch/num_keys/mixed_throughput.png}\\
            {\scriptsize\itshape Throughput + L2 TLB misses vs. working set}
    \end{columns}
\end{frame}
